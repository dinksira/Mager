...
export default function PortfolioModal({ isOpen, onClose, data }: PortfolioModalProps) {
  ...
  return createPortal(
    <div className={`modal-overlay portfolio-modal ${isOpen ? 'open' : ''}`} id="portfolioModal" onClick={(e) => { if (e.target === e.currentTarget) onClose(); }}>
      <div className="modal">
